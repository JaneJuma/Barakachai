...
<?php if ( $has_orders ) : ?>
	...
	{
		?>
		<div class="alert-message"><i class="fa fa-times close-alert" aria-hidden="true" style="float:right; cursor: pointer;"></i>
		Your order has been created. We've sent you an email confirming the order and in the same email, you'll find a payment link attached. Click on it to complete payment for the order.
		</div>
		<?php
	}
	?>
